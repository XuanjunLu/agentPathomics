...
class PathomicsRGT(base.PathomicsFeaturesBase):

    def __init__(self, inputImage, inputMask, **kwargs):
        super(PathomicsRGT, self).__init__(inputImage, inputMask, **kwargs)
        self.name = 'RGT'
    ...
    def getMeanTensorContrastEnergyFeatureValue(self):
        return self.features[0]

    def getStandardDeviationTensorContrastEnergyFeatureValue(self):
        return self.features[1]

    def getRangeTensorContrastEnergyFeatureValue(self):
        return self.features[2]

    def getMeanTensorContrastInverseMomentFeatureValue(self):
        return self.features[3]

    def getStandardDeviationTensorContrastInverseMomentFeatureValue(self):
        return self.features[4]

    def getRangeTensorContrastInverseMomentFeatureValue(self):
        return self.features[5]

    def getMeanTensorContrastAveFeatureValue(self):
        return self.features[6]

    def getStandardDeviationTensorContrastAveFeatureValue(self):
        return self.features[7]

    def getRangeTensorContrastAveFeatureValue(self):
        return self.features[8]

    def getMeanTensorContrastVarFeatureValue(self):
        return self.features[9]

    def getStandardDeviationTensorContrastVarFeatureValue(self):
        return self.features[10]

    def getRangeTensorContrastVarFeatureValue(self):
        return self.features[11]

    def getMeanTensorContrastEntropyFeatureValue(self):
        return self.features[12]

    def getStandardDeviationTensorContrastEntropyFeatureValue(self):
        return self.features[13]

    def getRangeTensorContrastEntropyFeatureValue(self):
        return self.features[14]

    def getMeanTensorIntensityAveFeatureValue(self):
        return self.features[15]

    def getStandardDeviationTensorIntensityAveFeatureValue(self):
        return self.features[16]

    def getRangeTensorIntensityAveFeatureValue(self):
        return self.features[17]

    def getMeanTensorIntensityVarianceFeatureValue(self):
        return self.features[18]

    def getStandardDeviationTensorIntensityVarianceFeatureValue(self):
        return self.features[19]

    def getRangeTensorIntensityVarianceFeatureValue(self):
        return self.features[20]

    def getMeanTensorIntensityEntropyFeatureValue(self):
        return self.features[21]

    def getStandardDeviationTensorIntensityEntropyFeatureValue(self):
        return self.features[22]

    def getRangeTensorIntensityEntropyFeatureValue(self):
        return self.features[23]

    def getMeanTensorEntropyFeatureValue(self):
        return self.features[24]

    def getStandardDeviationTensorEntropyFeatureValue(self):
        return self.features[25]

    def getRangeTensorEntropyFeatureValue(self):
        return self.features[26]

    def getMeanTensorEnergyFeatureValue(self):
        return self.features[27]

    def getStandardDeviationTensorEnergyFeatureValue(self):
        return self.features[28]

    def getRangeTensorEnergyFeatureValue(self):
        return self.features[29]

    def getMeanTensorCorrelationFeatureValue(self):
        return self.features[30]

    def getStandardDeviationTensorCorrelationFeatureValue(self):
        return self.features[31]

    def getRangeTensorCorrelationFeatureValue(self):
        return self.features[32]

    def getMeanTensorInformationMeasure1FeatureValue(self):
        return self.features[33]

    def getStandardDeviationTensorInformationMeasure1FeatureValue(self):
        return self.features[34]

    def getRangeTensorInformationMeasure1FeatureValue(self):
        return self.features[35]

    def getMeanTensorInformationMeasure2FeatureValue(self):
        return self.features[36]

    def getStandardDeviationTensorInformationMeasure2FeatureValue(self):
        return self.features[37]

    def getRangeTensorInformationMeasure2FeatureValue(self):
