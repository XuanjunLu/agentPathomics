...
from .rgt import construct_ccgs_optimized
...
class PathomicsLocalGraph(base.PathomicsFeaturesBase):

    def __init__(self, inputImage, inputMask, **kwargs):
        super(PathomicsLocalGraph, self).__init__(inputImage, inputMask,
                                                    **kwargs)
        self.name = 'LocalGraph'
    ...
    def getNumberOfNodesFeatureValue(self):
        return self.features[0]

    def getNumberOfEdgesFeatureValue(self):
        return self.features[1]

    def getAverageDegreeFeatureValue(self):
        return self.features[2]

    def getAverageEccentricityFeatureValue(self):
    ...
    def getAverageEccentricity90percentFeatureValue(self):
        return self.features[6]

    def getDiameter90percentFeatureValue(self):
        return self.features[7]

    def getRadius90percentFeatureValue(self):
        return self.features[8]

    def getAveragePathLengthFeatureValue(self):
        return self.features[9]

    def getClusteringCoefficientCFeatureValue(self):
        return self.features[10]

    def getClusteringCoefficientDFeatureValue(self):
        return self.features[11]

    def getClusteringCoefficientEFeatureValue(self):
        return self.features[12]

    def getNumberOfConnectedComponentsFeatureValue(self):
        return self.features[13]

    def getGiantConnectedComponentRatioFeatureValue(self):
        return self.features[14]

    def getAverageConnectedComponentSizeFeatureValue(self):
        return self.features[15]

    def getNumberIsolatedNodesFeatureValue(self):
        return self.features[16]

    def getPercentageIsolatedNodesFeatureValue(self):
        return self.features[17]

    def getNumberEndNodesFeatureValue(self):
        return self.features[18]

    def getPercentageEndNodesFeatureValue(self):
        return self.features[19]

    def getNumberCentralNodesFeatureValue(self):
        return self.features[20]

    def getPercentageCentralNodesFeatureValue(self):
        return self.features[21]

    def getMeanEdgeLengthFeatureValue(self):
        return self.features[22]

    def getStandardDeviationEdgeLengthFeatureValue(self):
        return self.features[23]

    def getSkewnessEdgeLengthFeatureValue(self):
        return self.features[24]

    def getKurtosisEdgeLengthFeatureValue(self):
