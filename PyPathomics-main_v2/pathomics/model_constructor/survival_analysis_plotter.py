...
if __name__ == '__main__':
    ...
    plotter = SurvivalAnalysisPlotter(
        data_file=r'D:\work_space\AI\PyPathomics-mainv4\PyPathomics-main\example_folder\aggregation\dataset_feature_matrix.csv',
        list_feats_selection=['Lasso', 'XGBoost'],
        list_classifiers=['QDA', 'LDA', 'RandomForest'],
        n_workers=3
    )
    plotter.km_curve_best_auc(
        best_feat_sel="XGBoost",
        best_classifier="RandomForest",
        save_path=r'D:\work_space\AI\PyPathomics-mainv4\PyPathomics-main\example_folder\cross_validation'
    )