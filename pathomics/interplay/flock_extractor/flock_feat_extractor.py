...
from pathomics.interplay.flock_extractor.flock.core import FlockCore, MeanShiftWrapper, FlockTypingKmeans
from matplotlib import pyplot as plt
from matplotlib.collections import LineCollection
from matplotlib import cm
import numpy as np
from pathomics.interplay.flock_extractor.flock.feature import *
...
def flock_feat_extractor(img, feat_inp, ifShowFig=False, bandwidth=80):
    ...
    feature_numerics_list = [fea.item() if fea.__class__ is np.ndarray else fea for fea in feature_numerics_list] #yuxin
